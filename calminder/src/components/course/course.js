            ...
            <div className={styles.wrapper}>
                <section className={styles.first_screen}>
                    ...
                    <div className = {styles.full}>
                        <p>We created a Udemy-course, a free Short Personal Online Course, that you can access via:<br></br>
                            <a href = "https://www.udemy.com/course/arts-mindfulness-in-education"
                                target = "_blank">
